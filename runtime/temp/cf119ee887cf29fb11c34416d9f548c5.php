<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:34:"template/zuoyou/html/vod/show.html";i:1774360482;s:77:"/www/wwwroot/www.yulee.ggff.net/video/template/zuoyou/html/public/seokey.html";i:1774360483;s:76:"/www/wwwroot/www.yulee.ggff.net/video/template/zuoyou/html/public/style.html";i:1774360483;s:77:"/www/wwwroot/www.yulee.ggff.net/video/template/zuoyou/html/public/header.html";i:1774360484;s:75:"/www/wwwroot/www.yulee.ggff.net/video/template/zuoyou/html/public/list.html";i:1774360483;s:75:"/www/wwwroot/www.yulee.ggff.net/video/template/zuoyou/html/public/page.html";i:1774360482;s:77:"/www/wwwroot/www.yulee.ggff.net/video/template/zuoyou/html/public/footer.html";i:1774360484;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
    <meta charset="UTF-8" />
    ...
    <div class="horizontal-menu">
        <div class="menu-items">
            <?php if($obj['type_pid'] == 0): if($maccms['aid'] == 11): ?>
                    <div class="menu-item"><a href="<?php echo mac_url_type($obj,[],'show'); ?>" <?php if($obj['type_pid'] == ''): ?>class="active"<?php endif; ?>>全部</a></div>
                    <?php else: ?>
                    <div class="menu-item"><a href="<?php echo mac_url_type($obj['type_id'],['id'=>$obj['type_id']],'show'); ?>" <?php if($obj['type_pid'] == ''): ?>class="active"<?php endif; ?>>全部</a></div>
                    <?php endif; else: if($maccms['aid'] == 11): ?>
                	<div class="menu-item"><a href="<?php echo mac_url_type($obj,[],'show'); ?>" <?php if($obj['type_pid'] == ''): ?>class="active"<?php endif; ?>>全部</a></div>
                <?php else: ?>
                	<div class="menu-item"><a href="<?php echo mac_url_type($obj['type_pid'],['id'=>$obj['type_pid']],'show'); ?>" <?php if($obj['type_pid'] == ''): ?>class="active"<?php endif; ?>>全部</a></div>
            ...
            <div class="menu-item"><a href="<?php echo mac_url_type($vo,[],'show'); ?>" <?php if(($vo['type_id'] == $GLOBALS['type_id'] || $vo['type_id'] == $GLOBALS['type_pid'])): ?>class="active"<?php endif; ?>><?php echo $vo['type_name']; ?></a></div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
    <?php endif; ?>
