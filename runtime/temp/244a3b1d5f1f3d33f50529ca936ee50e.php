<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:36:"template/zuoyou/html/label/rank.html";i:1774360481;s:76:"/www/wwwroot/www.yulee.ggff.net/video/template/zuoyou/html/public/style.html";i:1774360483;s:77:"/www/wwwroot/www.yulee.ggff.net/video/template/zuoyou/html/public/header.html";i:1774360484;s:75:"/www/wwwroot/www.yulee.ggff.net/video/template/zuoyou/html/public/list.html";i:1774360483;s:77:"/www/wwwroot/www.yulee.ggff.net/video/template/zuoyou/html/public/footer.html";i:1774360484;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
    <meta charset="UTF-8" />
    ...
    <meta name="keywords" content="排行榜,<?php echo $maccms['site_keywords']; ?>" />
    ...
    <meta itemprop="name" property="og:title" content="排行榜 - <?php echo $maccms['site_name']; ?>" />
...
<body>
    ...
    <?php $__TAG__ = '{"parent":"current","order":"asc","by":"sort","mid":"1","id":"vo3","key":"key"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($key % 2 );++$key;?>
  	<section>
        <h2 class="section-title"><?php echo $vo3['type_name']; ?>排行榜</h2>
    	 <div class="movie-list">
    	<?php $__TAG__ = '{"num":"16  type=","order":"desc","by":"score","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
