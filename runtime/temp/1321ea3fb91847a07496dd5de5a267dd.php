<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:36:"template/zuoyou/html/rss/google.html";i:1774360481;}*/ ?>
<?php echo '<?'; ?>
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:image="http://www.google.com/schemas/sitemap-image/1.1" xmlns:video="http://www.google.com/schemas/sitemap-video/1.1">
	...
	<url>
		...
		<video:video>
			<video:title>
				<![CDATA[<?php echo mac_filter_html($vo['vod_name']); ?>]]>
			</video:title>
			...
			<video:category>
				<![CDATA[<?php echo mac_filter_html($vo['type']['type_name']); ?>]]>
			</video:category>
