<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/www/wwwroot/www.yulee.ggff.net/video/application/admin/view/index/index.html";i:1629142480;s:77:"/www/wwwroot/www.yulee.ggff.net/video/application/admin/view/public/head.html";i:1629142480;s:77:"/www/wwwroot/www.yulee.ggff.net/video/application/admin/view/public/foot.html";i:1629142480;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-layout layui-layout-admin">
	...
	<ul class="layout-right" lay-filter="">	
		 <li class="nav-item">
			<a href="/video/" target="_blank"><i class="layui-icon layui-icon-home size-14"></i></a>
	     </li> 
		 <li class="nav-item ">
	    ...
	    <div class="bottom-nav">	
		  <ul class="layui-nav fl nobg main-nav " >
			...
			<ul class="layui-nav layui-layout-right" lay-filter="">
				...
				<li class="layui-nav-item layui-hide-xs">
                    <a href="/video/" target="_blank"><?php echo lang('admin/index/index/menu_index'); ?></a>
                </li>
			</ul>
		</div>
	</div>
	...
	<div class="nav-item-ul">
	  <div class="">
		  <ul class="layui-nav">
			  <li class="layui-nav-item"><a href="/video/" target="_blank"><?php echo lang('admin/index/index/menu_index'); ?></a></li>
